//FastLED DemoReel100.ino example by focalintent & kriegsman

///Changes from DemoReel100.ino example:
//changed to include 3 strips, added multiple LED types, changed LED type 1 to WS2802 for stair side LEDs
//data pins 3-5--put shorter side strip on pin 4 (different NUM_LEDS value), lettering on pin 5 (different NUM_LEDS & LED_TYPE)
//increased delay to 5 sec, 
